...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Programming\Projects\FullstackApp\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Programming\\Projects\\FullstackApp\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'debugbar.theme','debugbar.debug_backtrace_limit','typescript-transformer.auto_discover_types','typescript-transformer.collectors','typescript-transformer.transformers',
...
'listing.index','listing.show','listing.offer.store','realtor.listing.restore','realtor.listing.index',
...
'notification.index','notification.seen','storage.local',);
